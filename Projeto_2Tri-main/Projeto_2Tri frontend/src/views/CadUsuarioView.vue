<template>
    <main>
      <div class="prin-login">
        <div>
          <h1 class="tit-login"> Cadastrar </h1>
          <input placeholder="Nome de Usuário"/>
          <input type="password" placeholder="Senha"/>
        </div>
        <div>
          <button class="logar">Entrar</button>
          <button class="esqueci-senha">Esqueceu sua senha?</button>
          <p class="sem-conta">Não tem conta? <span class="cadastrar-conta"> <RouterLink to="/livros"> Inscreva-se </RouterLink> </span></p>
        </div>
      </div>       
    </main>
</template>
